...
$(document).ready(function () {
    ...
    $(".nav").find("a").on("click", function () {
        var _self = $(this);
        AddClick("menu_" + _self.html());
    });

    //var _share = $("<div style=\"display:none;\"><img src=\"Images/volvo-10.png\" alt=\"沃尔沃电子杂志\" /></div>");
    //_body.children().eq(0).before(_share);

    _title.text("沃尔沃电子杂志-" + _title.text());
});
